...
def post_api(request):
    if request.method == "POST":
        ...
        for i in range(jsonCk):
            if order[i]["restaurant"] in allData[i]["restaurant"]:
                print(allData)

        chart_list = [
            {
                "id":chartDate["id"],
                "regDate": chartDate["regDate"],
                "restaurant": chartDate["restaurant"],
                "personnel": chartDate["personnel"],
                "price": chartDate["price"]
            }
